Ext.onReady(function()
{
	...
	if (Ext.get('js-grid-placeholder'))
	{
		...
		intelli.albums.toolbar = Ext.create('Ext.Toolbar', {items:
		[
			{
				emptyText: _t('text'),
				name: 'text',
				...
				handler: function(){intelli.gridHelper.search(intelli.albums);},
				id: 'fltBtn',
				text: '<i class="i-search"></i> ' + _t('search')
			}, {
				handler: function(){intelli.gridHelper.search(intelli.albums, true);},
