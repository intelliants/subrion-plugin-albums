		...
		<div class="media-body">
			...
			{if isset($is_manage_albums) && $is_manage_albums}
				<form method="post" class="album-actions">
					...
					<a href="{$smarty.const.IA_SELF}#upload-photo" class="btn btn-mini btn-info" data-toggle="modal">
						<i class="icon-upload"></i>
						{lang key='upload_photo'}
					</a>
					<a href="{$smarty.const.IA_SELF}#create-album" id="album_edit" class="btn btn-mini btn-info" data-toggle="modal">
						<i class="icon-edit"></i>
						{lang key='edit'}
					</a>
					<button type="submit" class="btn btn-mini btn-danger delete" id="remove-album">
